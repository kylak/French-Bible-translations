...
**IMPORTANT**: If the translation doesn't contain any paragraph symbol (¶) but contains paragraphs, represent these paragraphs by adding the ¶ symbol in the beginning of verses that start new paragraphs. Don't put a whitespace between ¶ and the first word of the verse.
